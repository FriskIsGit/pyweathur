    ...
    with httpx.Client() as client:
        ...
        if 'data' in json_load:
            ...
            try:
                ...
                print('{}   Last observation time: {}'.format(data_map['country_code'], data_map['ob_time']))
            print('Temperature: %.1f C'%data_map['temp'])
            print('Sunrise: %s  Sunset: %s'%(data_map['sunrise'], data_map['sunset']))
            print('Description:', data_map['weather']['description'],'  Cloud Coverage', data_map['clouds'], "%")
